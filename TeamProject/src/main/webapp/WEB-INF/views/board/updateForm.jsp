            ...
            <div class="row">
                    <table class="table table-condensed">
                        <thead>
                            <tr align="center">
                            	 <th width="10%">글 제목 : </th>
                                <th width="100%"><h5><input type="text" name="boardSubject"  value="${boardDTO.boardSubject}" style="width:100%;"></h5></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td colspan="2">
                                    <p class="mb-4 mt-3"><textarea name="boardContent" rows="10" style="width:100%;" >${boardDTO.boardContent }</textarea></p>

                                </td>
                            </tr>
                            <tr>
                            		<td width="10%">파일</td>
                                	<td width="60%"><input type="file" name="file">${boardDTO.boardFile }
                                	<input type="hidden" name="oldfile" value="${boardDTO.boardFile }"></td>
                            </tr>
